...
export const buildTelegramMessageContext = async ({
  ...
  // Use the injected config snapshot for routing to keep session keys stable within a running bot
  // (and consistent with /models + callback-driven /model selections).
